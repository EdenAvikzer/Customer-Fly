...
public class Seat {
	...
	public Seat(int rowNum, String seatNum, SeatClass seatClass, String tailNumber) {
		super();
		this.rowNum = rowNum;
	...
	public Seat(int rowNum, String seatNum, SeatClass seatClass) {
		super();
		this.rowNum = rowNum;
		this.seatNum = seatNum;
		this.seatClass = seatClass;
	...
	public String toString() {
		return "Seat - row: " + rowNum + ", seat: " + seatNum + ", Class: " + seatClass;
	}
